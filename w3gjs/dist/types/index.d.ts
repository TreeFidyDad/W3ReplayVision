...
import RawParser, { type DataBlock, getUncompressedData } from "./parsers/RawParser";
import ReplayParser from "./parsers/ReplayParser";
export default W3GReplay;
export { GameDataParser, MetadataParser, RawParser, ReplayParser, getUncompressedData, type DataBlock, };
